module mainpkg.project {
    ...
    opens mainpkg.project.Rayhan to javafx.fxml, javafx.base ;
    opens mainpkg.project.Rayhan.User1 to javafx.fxml ;
    opens mainpkg.project.Rayhan.User2 to javafx.fxml, javafx.base ;
    opens mainpkg.project.Rayhan.User3 to javafx.fxml, javafx.base ;
